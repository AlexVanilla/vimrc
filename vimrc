...
" Disable automatic comment (formatoptions is 'fo') 
" FIXME: Don't think it's working!!!!!!!!  (ノಥ,_｣ಥ)ノ彡┻━┻
...
" Utility
Plugin 'christoomey/vim-system-copy' " Vim plugin for copying/pasting from the system clipboard
Plugin 'wakatime/vim-wakatime' " Keeps track on how much I've been coding
Plugin 'Townk/vim-autoclose' " plugin for Vim enable an auto-close chars
Plugin 'tpope/vim-surround' " Change the things that you surround stuff in ()'s, {}'s, html tags, etc
